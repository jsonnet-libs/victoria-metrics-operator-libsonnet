{
  ...
  spec: {
    ...
    '#externalConfig':: d.obj(help="\"ExternalConfig defines a source of external VMAuth configuration.\\nIf it's defined, configuration for vmauth becomes unmanaged and operator'll not create any related secrets/config-reloaders\""),
    externalConfig: {
      '#secretRef':: d.obj(help='"SecretRef defines selector for externally managed secret which contains configuration"'),
      secretRef: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { spec+: { externalConfig+: { secretRef+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { externalConfig+: { secretRef+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { spec+: { externalConfig+: { secretRef+: { optional: optional } } } },
      },
      '#withLocalPath':: d.fn(help='"LocalPath contains static path to a config, which is managed externally for cases\\nwhen using secrets is not applicable, e.g.: Vault sidecar."', args=[d.arg(name='localPath', type=d.T.string)]),
      withLocalPath(localPath): { spec+: { externalConfig+: { localPath: localPath } } },
    },
    ...
    '#unauthorizedUserAccessSpec':: d.obj(help='"UnauthorizedUserAccessSpec defines unauthorized_user config section of vmauth config"'),
    unauthorizedUserAccessSpec: {
      ...
      ip_filters: {
        ...
        withAllow_list(allow_list): { spec+: { unauthorizedUserAccessSpec+: { ip_filters+: { allow_list: if std.isArray(v=allow_list) then allow_list else [allow_list] } } } },
        ...
        withAllow_listMixin(allow_list): { spec+: { unauthorizedUserAccessSpec+: { ip_filters+: { allow_list+: if std.isArray(v=allow_list) then allow_list else [allow_list] } } } },
        '#withDeny_list':: d.fn(help='', args=[d.arg(name='deny_list', type=d.T.array)]),
        withDeny_list(deny_list): { spec+: { unauthorizedUserAccessSpec+: { ip_filters+: { deny_list: if std.isArray(v=deny_list) then deny_list else [deny_list] } } } },
        ...
        withDeny_listMixin(deny_list): { spec+: { unauthorizedUserAccessSpec+: { ip_filters+: { deny_list+: if std.isArray(v=deny_list) then deny_list else [deny_list] } } } },
      },
      '#tlsConfig':: d.obj(help='"TLSConfig defines tls configuration for the backend connection"'),
      tlsConfig: {
        ...
        ca: {
          ...
          configMap: {
            ...
            withKey(key): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { ca+: { configMap+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { ca+: { configMap+: { name: name } } } } } },
            ...
            withOptional(optional): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { ca+: { configMap+: { optional: optional } } } } } },
          },
          '#secret':: d.obj(help='"Secret containing data to use for the targets."'),
          secret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { ca+: { secret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { ca+: { secret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { ca+: { secret+: { optional: optional } } } } } },
          },
        },
        ...
        cert: {
          ...
          configMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { cert+: { configMap+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { cert+: { configMap+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { cert+: { configMap+: { optional: optional } } } } } },
          },
          '#secret':: d.obj(help='"Secret containing data to use for the targets."'),
          secret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { cert+: { secret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { cert+: { secret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { cert+: { secret+: { optional: optional } } } } } },
          },
        },
        '#keySecret':: d.obj(help='"Secret containing the client key file for the targets."'),
        keySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { keySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { keySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { keySecret+: { optional: optional } } } } },
        },
        '#withCaFile':: d.fn(help='"Path to the CA cert in the container to use for the targets."', args=[d.arg(name='caFile', type=d.T.string)]),
        withCaFile(caFile): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { caFile: caFile } } } },
        ...
        withCertFile(certFile): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { certFile: certFile } } } },
        ...
        withInsecureSkipVerify(insecureSkipVerify): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { insecureSkipVerify: insecureSkipVerify } } } },
        ...
        withKeyFile(keyFile): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { keyFile: keyFile } } } },
        '#withServerName':: d.fn(help='"Used to verify the hostname for the targets."', args=[d.arg(name='serverName', type=d.T.string)]),
        withServerName(serverName): { spec+: { unauthorizedUserAccessSpec+: { tlsConfig+: { serverName: serverName } } } },
      },
      '#url_map':: d.obj(help=''),
      url_map: {
        ...
        '#withDrop_src_path_prefix_parts':: d.fn(help='"DropSrcPathPrefixParts is the number of `/`-delimited request path prefix parts to drop before proxying the request to backend.\\nSee [here](https://docs.victoriametrics.com/victoriametrics/vmauth/#dropping-request-path-prefix) for more details."', args=[d.arg(name='drop_src_path_prefix_parts', type=d.T.integer)]),
        ...
        '#withLoad_balancing_policy':: d.fn(help='"LoadBalancingPolicy defines load balancing policy to use for backend urls.\\nSupported policies: least_loaded, first_available.\\nSee [here](https://docs.victoriametrics.com/victoriametrics/vmauth/#load-balancing) for more details (default \\"least_loaded\\")"', args=[d.arg(name='load_balancing_policy', type=d.T.string)]),
        ...
        '#withUrl_prefix':: d.fn(help='"UrlPrefix contains backend url prefixes for the proxied request url.\\nURLPrefix defines prefix prefix for destination"', args=[d.arg(name='url_prefix', type=d.T.any)]),
        withUrl_prefix(url_prefix): { url_prefix: url_prefix },
      },
      ...
      withDefault_url(default_url): { spec+: { unauthorizedUserAccessSpec+: { default_url: if std.isArray(v=default_url) then default_url else [default_url] } } },
      ...
      withDefault_urlMixin(default_url): { spec+: { unauthorizedUserAccessSpec+: { default_url+: if std.isArray(v=default_url) then default_url else [default_url] } } },
      '#withDiscover_backend_ips':: d.fn(help='"DiscoverBackendIPs instructs discovering URLPrefix backend IPs via DNS."', args=[d.arg(name='discover_backend_ips', type=d.T.boolean)]),
      withDiscover_backend_ips(discover_backend_ips): { spec+: { unauthorizedUserAccessSpec+: { discover_backend_ips: discover_backend_ips } } },
      '#withDrop_src_path_prefix_parts':: d.fn(help='"DropSrcPathPrefixParts is the number of `/`-delimited request path prefix parts to drop before proxying the request to backend.\\nSee [here](https://docs.victoriametrics.com/victoriametrics/vmauth/#dropping-request-path-prefix) for more details."', args=[d.arg(name='drop_src_path_prefix_parts', type=d.T.integer)]),
      withDrop_src_path_prefix_parts(drop_src_path_prefix_parts): { spec+: { unauthorizedUserAccessSpec+: { drop_src_path_prefix_parts: drop_src_path_prefix_parts } } },
      '#withDump_request_on_errors':: d.fn(help="\"DumpRequestOnErrors instructs vmauth to return detailed request params to the client\\nif routing rules don't allow to forward request to the backends.\\nUseful for debugging `src_hosts` and `src_headers` based routing rules\\n\\navailable since v1.107.0 vmauth version\"", args=[d.arg(name='dump_request_on_errors', type=d.T.boolean)]),
      withDump_request_on_errors(dump_request_on_errors): { spec+: { unauthorizedUserAccessSpec+: { dump_request_on_errors: dump_request_on_errors } } },
      '#withHeaders':: d.fn(help="\"Headers represent additional http headers, that vmauth uses\\nin form of [\\\"header_key: header_value\\\"]\\nmultiple values for header key:\\n[\\\"header_key: value1,value2\\\"]\\nit's available since 1.68.0 version of vmauth\"", args=[d.arg(name='headers', type=d.T.array)]),
      withHeaders(headers): { spec+: { unauthorizedUserAccessSpec+: { headers: if std.isArray(v=headers) then headers else [headers] } } },
      '#withHeadersMixin':: d.fn(help="\"Headers represent additional http headers, that vmauth uses\\nin form of [\\\"header_key: header_value\\\"]\\nmultiple values for header key:\\n[\\\"header_key: value1,value2\\\"]\\nit's available since 1.68.0 version of vmauth\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='headers', type=d.T.array)]),
      withHeadersMixin(headers): { spec+: { unauthorizedUserAccessSpec+: { headers+: if std.isArray(v=headers) then headers else [headers] } } },
      '#withLoad_balancing_policy':: d.fn(help='"LoadBalancingPolicy defines load balancing policy to use for backend urls.\\nSupported policies: least_loaded, first_available.\\nSee [here](https://docs.victoriametrics.com/victoriametrics/vmauth/#load-balancing) for more details (default \\"least_loaded\\")"', args=[d.arg(name='load_balancing_policy', type=d.T.string)]),
      withLoad_balancing_policy(load_balancing_policy): { spec+: { unauthorizedUserAccessSpec+: { load_balancing_policy: load_balancing_policy } } },
      ...
      withMax_concurrent_requests(max_concurrent_requests): { spec+: { unauthorizedUserAccessSpec+: { max_concurrent_requests: max_concurrent_requests } } },
      ...
      withMetric_labels(metric_labels): { spec+: { unauthorizedUserAccessSpec+: { metric_labels: metric_labels } } },
      ...
      withMetric_labelsMixin(metric_labels): { spec+: { unauthorizedUserAccessSpec+: { metric_labels+: metric_labels } } },
      '#withResponse_headers':: d.fn(help="\"ResponseHeaders represent additional http headers, that vmauth adds for request response\\nin form of [\\\"header_key: header_value\\\"]\\nmultiple values for header key:\\n[\\\"header_key: value1,value2\\\"]\\nit's available since 1.93.0 version of vmauth\"", args=[d.arg(name='response_headers', type=d.T.array)]),
      withResponse_headers(response_headers): { spec+: { unauthorizedUserAccessSpec+: { response_headers: if std.isArray(v=response_headers) then response_headers else [response_headers] } } },
      '#withResponse_headersMixin':: d.fn(help="\"ResponseHeaders represent additional http headers, that vmauth adds for request response\\nin form of [\\\"header_key: header_value\\\"]\\nmultiple values for header key:\\n[\\\"header_key: value1,value2\\\"]\\nit's available since 1.93.0 version of vmauth\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='response_headers', type=d.T.array)]),
      withResponse_headersMixin(response_headers): { spec+: { unauthorizedUserAccessSpec+: { response_headers+: if std.isArray(v=response_headers) then response_headers else [response_headers] } } },
      '#withRetry_status_codes':: d.fn(help='"RetryStatusCodes defines http status codes in numeric format for request retries\\ne.g. [429,503]"', args=[d.arg(name='retry_status_codes', type=d.T.array)]),
      withRetry_status_codes(retry_status_codes): { spec+: { unauthorizedUserAccessSpec+: { retry_status_codes: if std.isArray(v=retry_status_codes) then retry_status_codes else [retry_status_codes] } } },
      '#withRetry_status_codesMixin':: d.fn(help='"RetryStatusCodes defines http status codes in numeric format for request retries\\ne.g. [429,503]"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='retry_status_codes', type=d.T.array)]),
      withRetry_status_codesMixin(retry_status_codes): { spec+: { unauthorizedUserAccessSpec+: { retry_status_codes+: if std.isArray(v=retry_status_codes) then retry_status_codes else [retry_status_codes] } } },
      '#withUrl_map':: d.fn(help='', args=[d.arg(name='url_map', type=d.T.array)]),
      withUrl_map(url_map): { spec+: { unauthorizedUserAccessSpec+: { url_map: if std.isArray(v=url_map) then url_map else [url_map] } } },
      '#withUrl_mapMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='url_map', type=d.T.array)]),
      withUrl_mapMixin(url_map): { spec+: { unauthorizedUserAccessSpec+: { url_map+: if std.isArray(v=url_map) then url_map else [url_map] } } },
      '#withUrl_prefix':: d.fn(help='"URLPrefix defines prefix prefix for destination"', args=[d.arg(name='url_prefix', type=d.T.any)]),
      withUrl_prefix(url_prefix): { spec+: { unauthorizedUserAccessSpec+: { url_prefix: url_prefix } } },
    },
    ...
    '#withInternalListenPort':: d.fn(help='"InternalListenPort instructs vmauth to serve internal routes at given port\\navailable from v0.56.0 operator\\nand v1.111.0 vmauth version\\nrelated doc https://docs.victoriametrics.com/victoriametrics/vmauth/#security"', args=[d.arg(name='internalListenPort', type=d.T.string)]),
    withInternalListenPort(internalListenPort): { spec+: { internalListenPort: internalListenPort } },
    ...
    '#withUnauthorizedAccessConfig':: d.fn(help='"UnauthorizedAccessConfig configures access for un authorized users\\n\\nDeprecated: use unauthorizedUserAccessSpec instead\\nwill be removed at v1.0 release"', args=[d.arg(name='unauthorizedAccessConfig', type=d.T.any)]),
    withUnauthorizedAccessConfig(unauthorizedAccessConfig): { spec+: { unauthorizedAccessConfig: unauthorizedAccessConfig } },
    ...
    '#withUseProxyProtocol':: d.fn(help='"UseProxyProtocol enables proxy protocol for vmauth\\nhttps://www.haproxy.org/download/2.3/doc/proxy-protocol.txt"', args=[d.arg(name='useProxyProtocol', type=d.T.boolean)]),
    withUseProxyProtocol(useProxyProtocol): { spec+: { useProxyProtocol: useProxyProtocol } },
