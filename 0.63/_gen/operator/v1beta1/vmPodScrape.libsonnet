{
  ...
  spec: {
    ...
    podMetricsEndpoints: {
      ...
      '#withTargetPort':: d.fn(help='"TargetPort defines name or number of the pod port this endpoint refers to.\\nMutually exclusive with Port and PortNumber."', args=[d.arg(name='targetPort', type=d.T.any)]),
