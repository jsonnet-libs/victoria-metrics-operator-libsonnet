{
  ...
  spec: {
    ...
    vmBackup: {
      ...
      withExtraEnvsFrom(extraEnvsFrom): { spec+: { vmBackup+: { extraEnvsFrom: if std.isArray(v=extraEnvsFrom) then extraEnvsFrom else [extraEnvsFrom] } } },
      ...
      withExtraEnvsFromMixin(extraEnvsFrom): { spec+: { vmBackup+: { extraEnvsFrom+: if std.isArray(v=extraEnvsFrom) then extraEnvsFrom else [extraEnvsFrom] } } },
