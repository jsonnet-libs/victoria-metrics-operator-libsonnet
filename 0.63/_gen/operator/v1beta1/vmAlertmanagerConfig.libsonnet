  ...
  spec: {
    ...
    receivers: {
      ...
      discord_configs: {
        ...
        http_config: {
          ...
          oauth2: {
            ...
            withProxy_url(proxy_url): { http_config+: { oauth2+: { proxy_url: proxy_url } } },
            ...
            withTls_config(tls_config): { http_config+: { oauth2+: { tls_config: tls_config } } },
        ...
        '#withAvatar_url':: d.fn(help='"AvatarURL defines message avatar URL\\nAvailable from operator v0.55.0 and alertmanager v0.28.0"', args=[d.arg(name='avatar_url', type=d.T.string)]),
        withAvatar_url(avatar_url): { avatar_url: avatar_url },
        '#withContent':: d.fn(help='"Content defines message content template\\nAvailable from operator v0.55.0 and alertmanager v0.28.0"', args=[d.arg(name='content', type=d.T.string)]),
        ...
        '#withUsername':: d.fn(help='"Username defines message username\\nAvailable from operator v0.55.0 and alertmanager v0.28.0"', args=[d.arg(name='username', type=d.T.string)]),
      ...
      email_configs: {
        ...
        '#auth_secret':: d.obj(help='"AuthSecret defines secret name and key at CRD namespace.\\nIt must contain the CRAM-MD5 secret."'),
        auth_secret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      ...
      '#jira_configs':: d.obj(help=''),
      jira_configs: {
        '#withApi_url':: d.fn(help='"The URL to send API requests to. The full API path must be included.\\nExample: https://company.atlassian.net/rest/api/2/"', args=[d.arg(name='api_url', type=d.T.string)]),
        withApi_url(api_url): { api_url: api_url },
        '#withCustom_fields':: d.fn(help='"Other issue and custom fields.\\nJira issue field can have multiple types.\\nDepends on the field type, the values must be provided differently.\\nSee https://developer.atlassian.com/server/jira/platform/jira-rest-api-examples/#setting-custom-field-data-for-other-field-types for further examples."', args=[d.arg(name='custom_fields', type=d.T.object)]),
        withCustom_fields(custom_fields): { custom_fields: custom_fields },
        '#withCustom_fieldsMixin':: d.fn(help='"Other issue and custom fields.\\nJira issue field can have multiple types.\\nDepends on the field type, the values must be provided differently.\\nSee https://developer.atlassian.com/server/jira/platform/jira-rest-api-examples/#setting-custom-field-data-for-other-field-types for further examples."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='custom_fields', type=d.T.object)]),
        withCustom_fieldsMixin(custom_fields): { custom_fields+: custom_fields },
        '#withDescription':: d.fn(help='"Issue description template."', args=[d.arg(name='description', type=d.T.string)]),
        withDescription(description): { description: description },
        '#withHttp_config':: d.fn(help="\"The HTTP client's configuration. You must use this configuration to supply the personal access token (PAT) as part of the HTTP `Authorization` header.\\nFor Jira Cloud, use basic_auth with the email address as the username and the PAT as the password.\\nFor Jira Data Center, use the 'authorization' field with 'credentials: \u003cPAT value\u003e'.\"", args=[d.arg(name='http_config', type=d.T.any)]),
        withHttp_config(http_config): { http_config: http_config },
        '#withIssue_type':: d.fn(help='"Type of the issue (e.g. Bug)"', args=[d.arg(name='issue_type', type=d.T.string)]),
        withIssue_type(issue_type): { issue_type: issue_type },
        '#withLabels':: d.fn(help='"Labels to be added to the issue"', args=[d.arg(name='labels', type=d.T.array)]),
        withLabels(labels): { labels: if std.isArray(v=labels) then labels else [labels] },
        '#withLabelsMixin':: d.fn(help='"Labels to be added to the issue"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.array)]),
        withLabelsMixin(labels): { labels+: if std.isArray(v=labels) then labels else [labels] },
        '#withPriority':: d.fn(help='"Priority of the issue"', args=[d.arg(name='priority', type=d.T.string)]),
        withPriority(priority): { priority: priority },
        '#withProject':: d.fn(help='"The project key where issues are created"', args=[d.arg(name='project', type=d.T.string)]),
        withProject(project): { project: project },
        '#withReopen_duration':: d.fn(help='"If reopen_transition is defined, reopen the issue when it is not older than this value (rounded down to the nearest minute).\\nThe resolutiondate field is used to determine the age of the issue."', args=[d.arg(name='reopen_duration', type=d.T.string)]),
        withReopen_duration(reopen_duration): { reopen_duration: reopen_duration },
        '#withReopen_transition':: d.fn(help='"Name of the workflow transition to resolve an issue.\\nThe target status must have the category \\"done\\"."', args=[d.arg(name='reopen_transition', type=d.T.string)]),
        withReopen_transition(reopen_transition): { reopen_transition: reopen_transition },
        '#withResolve_transition':: d.fn(help='"Name of the workflow transition to reopen an issue.\\nThe target status should not have the category \\"done\\"."', args=[d.arg(name='resolve_transition', type=d.T.string)]),
        withResolve_transition(resolve_transition): { resolve_transition: resolve_transition },
        '#withSend_resolved':: d.fn(help='"SendResolved controls notify about resolved alerts."', args=[d.arg(name='send_resolved', type=d.T.boolean)]),
        withSend_resolved(send_resolved): { send_resolved: send_resolved },
        '#withSummary':: d.fn(help='"Issue summary template"', args=[d.arg(name='summary', type=d.T.string)]),
        withSummary(summary): { summary: summary },
        '#withWont_fix_resolution':: d.fn(help='"If reopen_transition is defined, ignore issues with that resolution."', args=[d.arg(name='wont_fix_resolution', type=d.T.string)]),
        withWont_fix_resolution(wont_fix_resolution): { wont_fix_resolution: wont_fix_resolution },
      },
      ...
      msteamsv2_configs: {
        ...
        '#withHttp_config':: d.fn(help='', args=[d.arg(name='http_config', type=d.T.any)]),
        withHttp_config(http_config): { http_config: http_config },
        '#withSend_resolved':: d.fn(help='"SendResolved controls notify about resolved alerts."', args=[d.arg(name='send_resolved', type=d.T.boolean)]),
        withSend_resolved(send_resolved): { send_resolved: send_resolved },
      ...
      '#rocketchat_configs':: d.obj(help=''),
      rocketchat_configs: {
        '#actions':: d.obj(help=''),
        actions: {
          '#withMsg':: d.fn(help='', args=[d.arg(name='msg', type=d.T.string)]),
          withMsg(msg): { msg: msg },
          '#withText':: d.fn(help='', args=[d.arg(name='text', type=d.T.string)]),
          withText(text): { text: text },
        ...
        '#token_id':: d.obj(help='"The sender token and token_id\\nSee https://docs.rocket.chat/use-rocket.chat/user-guides/user-panel/my-account#personal-access-tokens"'),
        token_id: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { token_id+: { key: key } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { token_id+: { name: name } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { token_id+: { optional: optional } },
        },
        ...
        withApi_url(api_url): { api_url: api_url },
        '#withChannel':: d.fn(help='"RocketChat channel override, (like #other-channel or @username)."', args=[d.arg(name='channel', type=d.T.string)]),
        withChannel(channel): { channel: channel },
        '#withColor':: d.fn(help='', args=[d.arg(name='color', type=d.T.string)]),
        withColor(color): { color: color },
        '#withEmoji':: d.fn(help='', args=[d.arg(name='emoji', type=d.T.string)]),
      ...
      telegram_configs: {
        ...
        withMessage(message): { message: message },
        '#withMessage_thread_id':: d.fn(help='"MessageThreadID defines ID of the message thread where to send the messages."', args=[d.arg(name='message_thread_id', type=d.T.integer)]),
        withMessage_thread_id(message_thread_id): { message_thread_id: message_thread_id },
      ...
      webhook_configs: {
        ...
        '#withSend_resolved':: d.fn(help='"SendResolved controls notify about resolved alerts."', args=[d.arg(name='send_resolved', type=d.T.boolean)]),
        withSend_resolved(send_resolved): { send_resolved: send_resolved },
        '#withTimeout':: d.fn(help='"Timeout is the maximum time allowed to invoke the webhook\\navailable since v0.28.0 alertmanager version"', args=[d.arg(name='timeout', type=d.T.string)]),
      ...
      '#withJira_configs':: d.fn(help='', args=[d.arg(name='jira_configs', type=d.T.array)]),
      withJira_configs(jira_configs): { jira_configs: if std.isArray(v=jira_configs) then jira_configs else [jira_configs] },
      '#withJira_configsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='jira_configs', type=d.T.array)]),
      withJira_configsMixin(jira_configs): { jira_configs+: if std.isArray(v=jira_configs) then jira_configs else [jira_configs] },
      ...
      '#withMsteamsv2_configs':: d.fn(help='', args=[d.arg(name='msteamsv2_configs', type=d.T.array)]),
      withMsteamsv2_configs(msteamsv2_configs): { msteamsv2_configs: if std.isArray(v=msteamsv2_configs) then msteamsv2_configs else [msteamsv2_configs] },
      '#withMsteamsv2_configsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='msteamsv2_configs', type=d.T.array)]),
      withMsteamsv2_configsMixin(msteamsv2_configs): { msteamsv2_configs+: if std.isArray(v=msteamsv2_configs) then msteamsv2_configs else [msteamsv2_configs] },
      ...
      '#withRocketchat_configs':: d.fn(help='', args=[d.arg(name='rocketchat_configs', type=d.T.array)]),
      withRocketchat_configs(rocketchat_configs): { rocketchat_configs: if std.isArray(v=rocketchat_configs) then rocketchat_configs else [rocketchat_configs] },
      '#withRocketchat_configsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='rocketchat_configs', type=d.T.array)]),
      withRocketchat_configsMixin(rocketchat_configs): { rocketchat_configs+: if std.isArray(v=rocketchat_configs) then rocketchat_configs else [rocketchat_configs] },
