  ...
  spec: {
    ...
    gossipConfig: {
      ...
      tls_client_config: {
        ...
        '#cert_secret_ref':: d.obj(help='"CertSecretRef defines reference for secret with certificate content under given key\\nmutually exclusive with CertFile"'),
        cert_secret_ref: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
    ...
    '#withClusterDomainName':: d.fn(help='"ClusterDomainName defines domain name suffix for in-cluster dns addresses\\naka .cluster.local\\nused to build pod peer addresses for in-cluster communication"', args=[d.arg(name='clusterDomainName', type=d.T.string)]),
    ...
    '#withDisableNamespaceMatcher':: d.fn(help="\"DisableNamespaceMatcher disables adding top route label matcher \\\"namespace = \u003cVMAlertmanagerConfig.namespace\u003e\\\" for VMAlertmanagerConfig\\nIt may be useful if alert doesn't have namespace label for some reason\"", args=[d.arg(name='disableNamespaceMatcher', type=d.T.boolean)]),
    ...
    '#withEnforcedNamespaceLabel':: d.fn(help='"EnforcedNamespaceLabel defines the namespace label key for top route matcher for VMAlertmanagerConfig\\nDefault is \\"namespace\\', args=[d.arg(name='enforcedNamespaceLabel', type=d.T.string)]),
    withEnforcedNamespaceLabel(enforcedNamespaceLabel): { spec+: { enforcedNamespaceLabel: enforcedNamespaceLabel } },
    '#withEnforcedTopRouteMatchers':: d.fn(help='"EnforcedTopRouteMatchers defines label matchers to be added for the top route\\nof VMAlertmanagerConfig\\nIt allows to make some set of labels required for alerts.\\nhttps://prometheus.io/docs/alerting/latest/configuration/#matcher"', args=[d.arg(name='enforcedTopRouteMatchers', type=d.T.array)]),
    withEnforcedTopRouteMatchers(enforcedTopRouteMatchers): { spec+: { enforcedTopRouteMatchers: if std.isArray(v=enforcedTopRouteMatchers) then enforcedTopRouteMatchers else [enforcedTopRouteMatchers] } },
    '#withEnforcedTopRouteMatchersMixin':: d.fn(help='"EnforcedTopRouteMatchers defines label matchers to be added for the top route\\nof VMAlertmanagerConfig\\nIt allows to make some set of labels required for alerts.\\nhttps://prometheus.io/docs/alerting/latest/configuration/#matcher"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='enforcedTopRouteMatchers', type=d.T.array)]),
    withEnforcedTopRouteMatchersMixin(enforcedTopRouteMatchers): { spec+: { enforcedTopRouteMatchers+: if std.isArray(v=enforcedTopRouteMatchers) then enforcedTopRouteMatchers else [enforcedTopRouteMatchers] } },
