{
  ...
  '#':: d.pkg(name='vlAgent', url='', help='"VLAgent - is a tiny but brave agent, which helps you collect logs from various sources and stores them in VictoriaLogs."'),
  ...
  '#new':: d.fn(help='new returns an instance of VLAgent', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.victoriametrics.com/v1',
    kind: 'VLAgent',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VLAgentSpec defines the desired state of VLAgent"'),
  spec: {
    '#claimTemplates':: d.obj(help='"ClaimTemplates allows adding additional VolumeClaimTemplates for VLAgent in Mode: StatefulSet"'),
    claimTemplates: {
    ...
    '#podMetadata':: d.obj(help='"PodMetadata configures Labels and Annotations which are propagated to the vlagent pods."'),
    podMetadata: {
      '#withAnnotations':: d.fn(help='"Annotations is an unstructured key value map stored with a resource that may be\\nset by external tools to store and retrieve arbitrary metadata. They are not\\nqueryable and should be preserved when modifying objects.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations"', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    remoteWrite: {
      ...
      oauth2: {
        '#clientIDSecret':: d.obj(help='"ClientIDSecret defines secret or configmap containing the OAuth2 client id"'),
        clientIDSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        ...
        '#withClientIDFile':: d.fn(help='"ClientIDFile defines path to pre-mounted OAuth2 client id"', args=[d.arg(name='clientIDFile', type=d.T.string)]),
        withClientIDFile(clientIDFile): { oauth2+: { clientIDFile: clientIDFile } },
        '#withClientSecretFile':: d.fn(help='"ClientSecretFile defines path to pre-mounted OAuth2 client secret"', args=[d.arg(name='clientSecretFile', type=d.T.string)]),
        withClientSecretFile(clientSecretFile): { oauth2+: { clientSecretFile: clientSecretFile } },
        '#withEndpointParams':: d.fn(help='"EndpointParams to append to the token URL"', args=[d.arg(name='endpointParams', type=d.T.object)]),
        withEndpointParams(endpointParams): { oauth2+: { endpointParams: endpointParams } },
        '#withEndpointParamsMixin':: d.fn(help='"EndpointParams to append to the token URL"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpointParams', type=d.T.object)]),
        withEndpointParamsMixin(endpointParams): { oauth2+: { endpointParams+: endpointParams } },
        '#withScopes':: d.fn(help='"Scopes used for the token request"', args=[d.arg(name='scopes', type=d.T.array)]),
        withScopes(scopes): { oauth2+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } },
        '#withScopesMixin':: d.fn(help='"Scopes used for the token request"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
        withScopesMixin(scopes): { oauth2+: { scopes+: if std.isArray(v=scopes) then scopes else [scopes] } },
        '#withTokenURL':: d.fn(help='"TokenURL defines URL to fetch the token from"', args=[d.arg(name='tokenURL', type=d.T.string)]),
      ...
      tlsConfig: {
        '#caSecretKeyRef':: d.obj(help='"CASecret defines secret reference with tls CA key by given key"'),
        caSecretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { tlsConfig+: { caSecretKeyRef+: { key: key } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { tlsConfig+: { caSecretKeyRef+: { name: name } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { tlsConfig+: { caSecretKeyRef+: { optional: optional } } },
        },
        '#certSecretKeyRef':: d.obj(help='"CertSecret defines secret reference with TLS cert by given key\\nmutually exclusive with CASecret"'),
        certSecretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { tlsConfig+: { certSecretKeyRef+: { key: key } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { tlsConfig+: { certSecretKeyRef+: { name: name } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { tlsConfig+: { certSecretKeyRef+: { optional: optional } } },
        },
        '#keySecretKeyRef':: d.obj(help='"CertSecret defines secret reference with TLS key by given key"'),
        keySecretKeyRef: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { tlsConfig+: { keySecretKeyRef+: { key: key } } },
          '#withName':: d.fn(help='"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { tlsConfig+: { keySecretKeyRef+: { name: name } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { tlsConfig+: { keySecretKeyRef+: { optional: optional } } },
        },
        '#withCaFile':: d.fn(help='"CAFile defines path to the pre-mounted file with TLS ca certificate"', args=[d.arg(name='caFile', type=d.T.string)]),
        withCaFile(caFile): { tlsConfig+: { caFile: caFile } },
        '#withCertFile':: d.fn(help='"CertFile defines path to the pre-mounted file with TLS certificate\\nmutually exclusive with CertSecret"', args=[d.arg(name='certFile', type=d.T.string)]),
        ...
        '#withKeyFile':: d.fn(help='"KeyFile defines path to the pre-mounted file with TLS cert key\\nmutually exclusive with CertSecret"', args=[d.arg(name='keyFile', type=d.T.string)]),
      ...
      '#withBearerTokenPath':: d.fn(help='"Optional bearer auth token to use for -remoteWrite.url"', args=[d.arg(name='bearerTokenPath', type=d.T.string)]),
      withBearerTokenPath(bearerTokenPath): { bearerTokenPath: bearerTokenPath },
      '#withHeaders':: d.fn(help='"Headers allow configuring custom http headers\\nMust be in form of semicolon separated header with value\\ne.g.\\nheaderName: headerValue"', args=[d.arg(name='headers', type=d.T.array)]),
    ...
    remoteWriteSettings: {
      ...
      '#withMaxBlockSize':: d.fn(help='"The maximum size of unpacked request to send to remote storage"', args=[d.arg(name='maxBlockSize', type=d.T.any)]),
      ...
      '#withTmpDataPath':: d.fn(help='"Path to directory where temporary data for remote write component is stored (default /vlagent_pq/vlagent-remotewrite-data)\\nIf defined, operator ignores spec.storage field and skips adding volume and volumeMount for pq"', args=[d.arg(name='tmpDataPath', type=d.T.string)]),
    ...
    '#serviceSpec':: d.obj(help='"ServiceSpec that will be added to vlagent service spec"'),
    serviceSpec: {
    ...
    '#storage':: d.obj(help='"StatefulStorage configures storage for StatefulSet"'),
    storage: {
    ...
    syslogSpec: {
      ...
      withTcpListeners(tcpListeners): { spec+: { syslogSpec+: { tcpListeners: if std.isArray(v=tcpListeners) then tcpListeners else [tcpListeners] } } },
      ...
      withTcpListenersMixin(tcpListeners): { spec+: { syslogSpec+: { tcpListeners+: if std.isArray(v=tcpListeners) then tcpListeners else [tcpListeners] } } },
      ...
      withUdpListeners(udpListeners): { spec+: { syslogSpec+: { udpListeners: if std.isArray(v=udpListeners) then udpListeners else [udpListeners] } } },
      ...
      withUdpListenersMixin(udpListeners): { spec+: { syslogSpec+: { udpListeners+: if std.isArray(v=udpListeners) then udpListeners else [udpListeners] } } },
    },
    ...
    '#withClaimTemplates':: d.fn(help='"ClaimTemplates allows adding additional VolumeClaimTemplates for VLAgent in Mode: StatefulSet"', args=[d.arg(name='claimTemplates', type=d.T.array)]),
    ...
    '#withClaimTemplatesMixin':: d.fn(help='"ClaimTemplates allows adding additional VolumeClaimTemplates for VLAgent in Mode: StatefulSet"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claimTemplates', type=d.T.array)]),
    ...
    '#withLogFormat':: d.fn(help='"LogFormat for VLAgent to be configured with."', args=[d.arg(name='logFormat', type=d.T.string)]),
    withLogFormat(logFormat): { spec+: { logFormat: logFormat } },
    '#withLogLevel':: d.fn(help='"LogLevel for VLAgent to be configured with.\\nINFO, WARN, ERROR, FATAL, PANIC"', args=[d.arg(name='logLevel', type=d.T.string)]),
    ...
    '#withRemoteWrite':: d.fn(help='"RemoteWrite list of victoria logs endpoints\\nfor victorialogs it must looks like: http://victoria-logs-single:9428/\\nor for cluster different url\\nhttps://docs.victoriametrics.com/victorialogs/vlagent/#replication-and-high-availability"', args=[d.arg(name='remoteWrite', type=d.T.array)]),
    withRemoteWrite(remoteWrite): { spec+: { remoteWrite: if std.isArray(v=remoteWrite) then remoteWrite else [remoteWrite] } },
    '#withRemoteWriteMixin':: d.fn(help='"RemoteWrite list of victoria logs endpoints\\nfor victorialogs it must looks like: http://victoria-logs-single:9428/\\nor for cluster different url\\nhttps://docs.victoriametrics.com/victorialogs/vlagent/#replication-and-high-availability"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='remoteWrite', type=d.T.array)]),
    ...
    '#withServiceScrapeSpec':: d.fn(help='"ServiceScrapeSpec that will be added to vlagent VMServiceScrape spec"', args=[d.arg(name='serviceScrapeSpec', type=d.T.object)]),
    withServiceScrapeSpec(serviceScrapeSpec): { spec+: { serviceScrapeSpec: serviceScrapeSpec } },
    '#withServiceScrapeSpecMixin':: d.fn(help='"ServiceScrapeSpec that will be added to vlagent VMServiceScrape spec"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceScrapeSpec', type=d.T.object)]),
