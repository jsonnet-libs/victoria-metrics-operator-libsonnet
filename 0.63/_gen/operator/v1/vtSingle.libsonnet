{
  ...
  '#':: d.pkg(name='vtSingle', url='', help='"VTSingle is fast, cost-effective and scalable traces database.\\nVTSingle is the Schema for the API"'),
  ...
  '#new':: d.fn(help='new returns an instance of VTSingle', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.victoriametrics.com/v1',
    kind: 'VTSingle',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VTSingleSpec defines the desired state of VTSingle"'),
  spec: {
    ...
    '#podMetadata':: d.obj(help='"PodMetadata configures Labels and Annotations which are propagated to the VTSingle pods."'),
    podMetadata: {
      '#withAnnotations':: d.fn(help='"Annotations is an unstructured key value map stored with a resource that may be\\nset by external tools to store and retrieve arbitrary metadata. They are not\\nqueryable and should be preserved when modifying objects.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations"', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    '#serviceSpec':: d.obj(help='"ServiceSpec that will be added to vtsingle service spec"'),
    serviceSpec: {
    ...
    '#storage':: d.obj(help='"Storage is the definition of how storage will be used by the VTSingle\\nby default it`s empty dir"'),
    storage: {
    ...
    '#storageMetadata':: d.obj(help='"StorageMeta defines annotations and labels attached to PVC for given vtsingle CR"'),
    storageMetadata: {
      '#withAnnotations':: d.fn(help='"Annotations is an unstructured key value map stored with a resource that may be\\nset by external tools to store and retrieve arbitrary metadata. They are not\\nqueryable and should be preserved when modifying objects.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations"', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    '#withLogFormat':: d.fn(help='"LogFormat for VTSingle to be configured with."', args=[d.arg(name='logFormat', type=d.T.string)]),
    ...
    '#withLogLevel':: d.fn(help='"LogLevel for VictoriaTraces to be configured with."', args=[d.arg(name='logLevel', type=d.T.string)]),
    ...
    '#withServiceScrapeSpec':: d.fn(help='"ServiceScrapeSpec that will be added to vtsingle VMServiceScrape spec"', args=[d.arg(name='serviceScrapeSpec', type=d.T.object)]),
    withServiceScrapeSpec(serviceScrapeSpec): { spec+: { serviceScrapeSpec: serviceScrapeSpec } },
    '#withServiceScrapeSpecMixin':: d.fn(help='"ServiceScrapeSpec that will be added to vtsingle VMServiceScrape spec"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceScrapeSpec', type=d.T.object)]),
    ...
    '#withStorageDataPath':: d.fn(help='"StorageDataPath disables spec.storage option and overrides arg for victoria-traces binary --storageDataPath,\\nits users responsibility to mount proper device into given path."', args=[d.arg(name='storageDataPath', type=d.T.string)]),
