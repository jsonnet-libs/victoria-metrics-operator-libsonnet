{
  ...
  '#':: d.pkg(name='vlSingle', url='', help='"VLSingle is fast, cost-effective and scalable logs database.\\nVLSingle is the Schema for the API"'),
  ...
  '#new':: d.fn(help='new returns an instance of VLSingle', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.victoriametrics.com/v1',
    kind: 'VLSingle',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VLSingleSpec defines the desired state of VLSingle"'),
  spec: {
    ...
    '#podMetadata':: d.obj(help='"PodMetadata configures Labels and Annotations which are propagated to the VLSingle pods."'),
    podMetadata: {
      '#withAnnotations':: d.fn(help='"Annotations is an unstructured key value map stored with a resource that may be\\nset by external tools to store and retrieve arbitrary metadata. They are not\\nqueryable and should be preserved when modifying objects.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations"', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    '#serviceSpec':: d.obj(help='"ServiceSpec that will be added to vlsingle service spec"'),
    serviceSpec: {
    ...
    '#storage':: d.obj(help='"Storage is the definition of how storage will be used by the VLSingle\\nby default it`s empty dir"'),
    storage: {
    ...
    '#storageMetadata':: d.obj(help='"StorageMeta defines annotations and labels attached to PVC for given vlsingle CR"'),
    storageMetadata: {
      '#withAnnotations':: d.fn(help='"Annotations is an unstructured key value map stored with a resource that may be\\nset by external tools to store and retrieve arbitrary metadata. They are not\\nqueryable and should be preserved when modifying objects.\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations"', args=[d.arg(name='annotations', type=d.T.object)]),
    ...
    '#withLogFormat':: d.fn(help='"LogFormat for VLSingle to be configured with."', args=[d.arg(name='logFormat', type=d.T.string)]),
    ...
    withRetentionMaxDiskSpaceUsageBytes(retentionMaxDiskSpaceUsageBytes): { spec+: { retentionMaxDiskSpaceUsageBytes: retentionMaxDiskSpaceUsageBytes } },
    ...
    '#withServiceScrapeSpec':: d.fn(help='"ServiceScrapeSpec that will be added to vlsingle VMServiceScrape spec"', args=[d.arg(name='serviceScrapeSpec', type=d.T.object)]),
    withServiceScrapeSpec(serviceScrapeSpec): { spec+: { serviceScrapeSpec: serviceScrapeSpec } },
    '#withServiceScrapeSpecMixin':: d.fn(help='"ServiceScrapeSpec that will be added to vlsingle VMServiceScrape spec"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceScrapeSpec', type=d.T.object)]),
