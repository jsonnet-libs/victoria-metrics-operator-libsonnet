---
permalink: /0.63/operator/v1beta1/vmSingle/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.vmBackup`](#obj-specvmbackup)
    ...
    * [`fn withExtraEnvsFrom(extraEnvsFrom)`](#fn-specvmbackupwithextraenvsfrom)
    * [`fn withExtraEnvsFromMixin(extraEnvsFrom)`](#fn-specvmbackupwithextraenvsfrommixin)
    ...
    * [`obj spec.vmBackup.extraEnvsFrom`](#obj-specvmbackupextraenvsfrom)
      * [`fn withPrefix(prefix)`](#fn-specvmbackupextraenvsfromwithprefix)
      * [`obj spec.vmBackup.extraEnvsFrom.configMapRef`](#obj-specvmbackupextraenvsfromconfigmapref)
        * [`fn withName(name)`](#fn-specvmbackupextraenvsfromconfigmaprefwithname)
        * [`fn withOptional(optional)`](#fn-specvmbackupextraenvsfromconfigmaprefwithoptional)
      * [`obj spec.vmBackup.extraEnvsFrom.secretRef`](#obj-specvmbackupextraenvsfromsecretref)
        * [`fn withName(name)`](#fn-specvmbackupextraenvsfromsecretrefwithname)
        * [`fn withOptional(optional)`](#fn-specvmbackupextraenvsfromsecretrefwithoptional)
    ...
    * [`obj spec.vmBackup.resources`](#obj-specvmbackupresources)
      ...
      * [`obj spec.vmBackup.resources.claims`](#obj-specvmbackupresourcesclaims)
        ...
        * [`fn withRequest(request)`](#fn-specvmbackupresourcesclaimswithrequest)
...
### fn spec.vmBackup.withExtraEnvsFrom
...
### fn spec.vmBackup.withExtraEnvsFromMixin
...
## obj spec.vmBackup.extraEnvsFrom

"ExtraEnvsFrom defines source of env variables for the application container\ncould either be secret or configmap"

### fn spec.vmBackup.extraEnvsFrom.withPrefix
...
## obj spec.vmBackup.extraEnvsFrom.configMapRef

"The ConfigMap to select from"

### fn spec.vmBackup.extraEnvsFrom.configMapRef.withName
...
### fn spec.vmBackup.extraEnvsFrom.configMapRef.withOptional
...
## obj spec.vmBackup.extraEnvsFrom.secretRef

"The Secret to select from"

### fn spec.vmBackup.extraEnvsFrom.secretRef.withName
...
### fn spec.vmBackup.extraEnvsFrom.secretRef.withOptional
...
### fn spec.vmBackup.resources.claims.withRequest
