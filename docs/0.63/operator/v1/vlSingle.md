---
permalink: /0.63/operator/v1/vlSingle/
---

# operator.v1.vlSingle
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withFutureRetention(futureRetention)`](#fn-specwithfutureretention)
  ...
  * [`fn withLogIngestedRows(logIngestedRows)`](#fn-specwithlogingestedrows)
  * [`fn withLogLevel(logLevel)`](#fn-specwithloglevel)
  * [`fn withLogNewStreams(logNewStreams)`](#fn-specwithlognewstreams)
  ...
  * [`fn withRetentionMaxDiskSpaceUsageBytes(retentionMaxDiskSpaceUsageBytes)`](#fn-specwithretentionmaxdiskspaceusagebytes)
...
new returns an instance of VLSingle
...
### fn spec.withRetentionMaxDiskSpaceUsageBytes
