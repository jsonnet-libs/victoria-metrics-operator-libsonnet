{
  ...
  spec: {
    ...
    remoteWrite: {
      ...
      '#withMaxDiskUsage':: d.fn(help='"MaxDiskUsage defines the maximum file-based buffer size in bytes for -remoteWrite.url"', args=[d.arg(name='maxDiskUsage', type=d.T.string)]),
