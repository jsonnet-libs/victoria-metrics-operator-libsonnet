{
  ...
  spec: {
    ...
    endpoints: {
      ...
      withMax_scrape_size(max_scrape_size): { max_scrape_size: max_scrape_size },
      ...
      '#withPort':: d.fn(help='"Name of the port exposed at Service."', args=[d.arg(name='port', type=d.T.string)]),
