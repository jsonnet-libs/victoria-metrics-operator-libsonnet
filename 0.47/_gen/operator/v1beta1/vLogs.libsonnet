{
  ...
  spec: {
    ...
    '#extraEnvs':: d.obj(help='"ExtraEnvs that will be added to VLogs pod"'),
    extraEnvs: {
    ...
    '#image':: d.obj(help='"Image - docker image settings for VLogs\\nif no specified operator uses default config version"'),
    image: {
    ...
    '#withConfigMaps':: d.fn(help='"ConfigMaps is a list of ConfigMaps in the same namespace as the VLogs\\nobject, which shall be mounted into the VLogs Pods."', args=[d.arg(name='configMaps', type=d.T.array)]),
    withConfigMaps(configMaps): { spec+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } },
    '#withConfigMapsMixin':: d.fn(help='"ConfigMaps is a list of ConfigMaps in the same namespace as the VLogs\\nobject, which shall be mounted into the VLogs Pods."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configMaps', type=d.T.array)]),
    ...
    '#withReplicaCount':: d.fn(help='"ReplicaCount is the expected size of the VLogs\\nit can be 0 or 1\\nif you need more - use vm cluster"', args=[d.arg(name='replicaCount', type=d.T.integer)]),
    ...
    '#withSecrets':: d.fn(help='"Secrets is a list of Secrets in the same namespace as the VLogs\\nobject, which shall be mounted into the VLogs Pods."', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecrets(secrets): { spec+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withSecretsMixin':: d.fn(help='"Secrets is a list of Secrets in the same namespace as the VLogs\\nobject, which shall be mounted into the VLogs Pods."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
