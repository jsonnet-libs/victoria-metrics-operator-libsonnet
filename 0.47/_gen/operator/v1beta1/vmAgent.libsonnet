{
  ...
  spec: {
    ...
    '#extraEnvs':: d.obj(help='"ExtraEnvs that will be added to VMAgent pod"'),
    extraEnvs: {
    ...
    '#host_aliases':: d.obj(help='"HostAliases provides mapping between ip and hostnames,\\nthat would be propagated to pod,\\ncannot be used with HostNetwork."'),
    host_aliases: {
    ...
    '#image':: d.obj(help='"Image - docker image settings for VMAgent\\nif no specified operator uses default config version"'),
    image: {
    ...
    remoteWrite: {
      ...
      streamAggrConfig: {
        ...
        '#withIgnoreFirstIntervals':: d.fn(help='', args=[d.arg(name='ignoreFirstIntervals', type=d.T.integer)]),
    ...
    remoteWriteSettings: {
      ...
      '#withMaxDiskUsagePerURL':: d.fn(help='"The maximum file-based buffer size in bytes at -remoteWrite.tmpDataPath"', args=[d.arg(name='maxDiskUsagePerURL', type=d.T.integer)]),
    ...
    '#staticScrapeSelector':: d.obj(help='"StaticScrapeSelector defines PodScrapes to be selected for target discovery.\\nWorks in combination with NamespaceSelector.\\nIf both nil - match everything.\\nNamespaceSelector nil - only objects at VMAgent namespace.\\nSelector nil - only objects at NamespaceSelector namespaces."'),
    ...
    '#volumeMounts':: d.obj(help='"VolumeMounts allows configuration of additional VolumeMounts on the output deploy definition.\\nVolumeMounts specified will be appended to other VolumeMounts in the vmagent container,\\nthat are generated as a result of StorageSpec objects."'),
    volumeMounts: {
    ...
    '#withDnsPolicy':: d.fn(help='"DNSPolicy set DNS policy for the pod"', args=[d.arg(name='dnsPolicy', type=d.T.string)]),
    ...
    '#withHost_aliases':: d.fn(help='"HostAliases provides mapping between ip and hostnames,\\nthat would be propagated to pod,\\ncannot be used with HostNetwork."', args=[d.arg(name='host_aliases', type=d.T.array)]),
    withHost_aliases(host_aliases): { spec+: { host_aliases: if std.isArray(v=host_aliases) then host_aliases else [host_aliases] } },
    '#withHost_aliasesMixin':: d.fn(help='"HostAliases provides mapping between ip and hostnames,\\nthat would be propagated to pod,\\ncannot be used with HostNetwork."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='host_aliases', type=d.T.array)]),
    ...
    '#withRemoteWrite':: d.fn(help='"RemoteWrite list of victoria metrics /some other remote write system\\nfor vm it must looks like: http://victoria-metrics-single:8429/api/v1/write\\nor for cluster different url\\nhttps://github.com/VictoriaMetrics/VictoriaMetrics/tree/master/app/vmagent#splitting-data-streams-among-multiple-systems"', args=[d.arg(name='remoteWrite', type=d.T.array)]),
    ...
    '#withReplicaCount':: d.fn(help='"ReplicaCount is the expected size of the VMAgent cluster. The controller will\\neventually make the size of the running cluster equal to the expected\\nsize.\\nNOTE enable VMSingle deduplication for replica usage"', args=[d.arg(name='replicaCount', type=d.T.integer)]),
    ...
    '#withSecrets':: d.fn(help='"Secrets is a list of Secrets in the same namespace as the vmagent\\nobject, which shall be mounted into the vmagent Pods.\\nwill be mounted at path /etc/vm/secrets"', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecrets(secrets): { spec+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withSecretsMixin':: d.fn(help='"Secrets is a list of Secrets in the same namespace as the vmagent\\nobject, which shall be mounted into the vmagent Pods.\\nwill be mounted at path /etc/vm/secrets"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
