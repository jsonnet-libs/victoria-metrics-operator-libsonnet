{
  ...
  '#new':: d.fn(help='new returns an instance of VMServiceScrape', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.victoriametrics.com/v1beta1',
    kind: 'VMServiceScrape',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VMServiceScrapeSpec defines the desired state of VMServiceScrape"'),
  spec: {
    ...
    attach_metadata: {
      ...
      withNode(node): { spec+: { attach_metadata+: { node: node } } },
    },
    '#endpoints':: d.obj(help='"A list of endpoints allowed as part of this ServiceScrape."'),
    endpoints: {
      '#attach_metadata':: d.obj(help='"AttachMetadata configures metadata attaching from service discovery"'),
      attach_metadata: {
        '#withNode':: d.fn(help='"Node instructs vmagent to add node specific metadata from service discovery\\nValid for roles: pod, endpoints, endpointslice."', args=[d.arg(name='node', type=d.T.boolean)]),
      ...
      vm_scrape_params: {
        ...
        proxy_client_config: {
          ...
          basic_auth: {
            ...
            password: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { vm_scrape_params+: { proxy_client_config+: { basic_auth+: { password+: { key: key } } } } },
              '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { vm_scrape_params+: { proxy_client_config+: { basic_auth+: { password+: { name: name } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { basic_auth+: { password+: { optional: optional } } } } },
            },
            '#username':: d.obj(help='"The secret in the service scrape namespace that contains the username\\nfor authentication.\\nIt must be at them same namespace as CRD"'),
            username: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { vm_scrape_params+: { proxy_client_config+: { basic_auth+: { username+: { key: key } } } } },
              '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { vm_scrape_params+: { proxy_client_config+: { basic_auth+: { username+: { name: name } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { basic_auth+: { username+: { optional: optional } } } } },
            },
            '#withPassword_file':: d.fn(help='"PasswordFile defines path to password file at disk"', args=[d.arg(name='password_file', type=d.T.string)]),
            withPassword_file(password_file): { vm_scrape_params+: { proxy_client_config+: { basic_auth+: { password_file: password_file } } } },
          },
          '#bearer_token':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          bearer_token: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { vm_scrape_params+: { proxy_client_config+: { bearer_token+: { key: key } } } },
            '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { vm_scrape_params+: { proxy_client_config+: { bearer_token+: { name: name } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { bearer_token+: { optional: optional } } } },
          },
          ...
          tls_config: {
            ...
            ca: {
              ...
              configMap: {
                '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { ca+: { configMap+: { key: key } } } } } },
                '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { ca+: { configMap+: { name: name } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { ca+: { configMap+: { optional: optional } } } } } },
              },
              '#secret':: d.obj(help='"Secret containing data to use for the targets."'),
              secret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { ca+: { secret+: { key: key } } } } } },
                '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { ca+: { secret+: { name: name } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { ca+: { secret+: { optional: optional } } } } } },
              },
            },
            '#cert':: d.obj(help='"Struct containing the client cert file for the targets."'),
            cert: {
              ...
              configMap: {
                '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { cert+: { configMap+: { key: key } } } } } },
                '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { cert+: { configMap+: { name: name } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { cert+: { configMap+: { optional: optional } } } } } },
              },
              '#secret':: d.obj(help='"Secret containing data to use for the targets."'),
              secret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { cert+: { secret+: { key: key } } } } } },
                '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { cert+: { secret+: { name: name } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { cert+: { secret+: { optional: optional } } } } } },
              },
            },
            '#keySecret':: d.obj(help='"Secret containing the client key file for the targets."'),
            keySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { keySecret+: { key: key } } } } },
              '#withName':: d.fn(help="\"Name of the referent.\\nThis field is effectively required, but due to backwards compatibility is\\nallowed to be empty. Instances of this type with an empty value here are\\nalmost certainly wrong.\\nTODO: Add other useful fields. apiVersion, kind, uid?\\nMore info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names\\nTODO: Drop `kubebuilder:default` when controller-gen doesn't need it https://github.com/kubernetes-sigs/kubebuilder/issues/3896.\"", args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { keySecret+: { name: name } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { keySecret+: { optional: optional } } } } },
            },
            '#withCaFile':: d.fn(help='"Path to the CA cert in the container to use for the targets."', args=[d.arg(name='caFile', type=d.T.string)]),
            withCaFile(caFile): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { caFile: caFile } } } },
            '#withCertFile':: d.fn(help='"Path to the client cert file in the container for the targets."', args=[d.arg(name='certFile', type=d.T.string)]),
            withCertFile(certFile): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { certFile: certFile } } } },
            '#withInsecureSkipVerify':: d.fn(help='"Disable target certificate validation."', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
            withInsecureSkipVerify(insecureSkipVerify): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { insecureSkipVerify: insecureSkipVerify } } } },
            '#withKeyFile':: d.fn(help='"Path to the client key file in the container for the targets."', args=[d.arg(name='keyFile', type=d.T.string)]),
            withKeyFile(keyFile): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { keyFile: keyFile } } } },
            '#withServerName':: d.fn(help='"Used to verify the hostname for the targets."', args=[d.arg(name='serverName', type=d.T.string)]),
            withServerName(serverName): { vm_scrape_params+: { proxy_client_config+: { tls_config+: { serverName: serverName } } } },
          },
          '#withBearer_token_file':: d.fn(help='', args=[d.arg(name='bearer_token_file', type=d.T.string)]),
          withBearer_token_file(bearer_token_file): { vm_scrape_params+: { proxy_client_config+: { bearer_token_file: bearer_token_file } } },
        },
        '#withDisable_compression':: d.fn(help='', args=[d.arg(name='disable_compression', type=d.T.boolean)]),
        withDisable_compression(disable_compression): { vm_scrape_params+: { disable_compression: disable_compression } },
        '#withDisable_keep_alive':: d.fn(help='"disable_keepalive allows disabling HTTP keep-alive when scraping targets.\\nBy default, HTTP keep-alive is enabled, so TCP connections to scrape targets\\ncould be re-used.\\nSee https://docs.victoriametrics.com/vmagent.html#scrape_config-enhancements"', args=[d.arg(name='disable_keep_alive', type=d.T.boolean)]),
        withDisable_keep_alive(disable_keep_alive): { vm_scrape_params+: { disable_keep_alive: disable_keep_alive } },
        ...
        withHeaders(headers): { vm_scrape_params+: { headers: if std.isArray(v=headers) then headers else [headers] } },
        ...
        withHeadersMixin(headers): { vm_scrape_params+: { headers+: if std.isArray(v=headers) then headers else [headers] } },
        '#withMetric_relabel_debug':: d.fn(help='"deprecated since [v1.85](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.85.0), will be removed in next release"', args=[d.arg(name='metric_relabel_debug', type=d.T.boolean)]),
        withMetric_relabel_debug(metric_relabel_debug): { vm_scrape_params+: { metric_relabel_debug: metric_relabel_debug } },
        '#withNo_stale_markers':: d.fn(help='', args=[d.arg(name='no_stale_markers', type=d.T.boolean)]),
        withNo_stale_markers(no_stale_markers): { vm_scrape_params+: { no_stale_markers: no_stale_markers } },
        '#withRelabel_debug':: d.fn(help='"deprecated since [v1.85](https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v1.85.0), will be removed in next release"', args=[d.arg(name='relabel_debug', type=d.T.boolean)]),
        withRelabel_debug(relabel_debug): { vm_scrape_params+: { relabel_debug: relabel_debug } },
        '#withScrape_align_interval':: d.fn(help='', args=[d.arg(name='scrape_align_interval', type=d.T.string)]),
        withScrape_align_interval(scrape_align_interval): { vm_scrape_params+: { scrape_align_interval: scrape_align_interval } },
        '#withScrape_offset':: d.fn(help='', args=[d.arg(name='scrape_offset', type=d.T.string)]),
        withScrape_offset(scrape_offset): { vm_scrape_params+: { scrape_offset: scrape_offset } },
        '#withStream_parse':: d.fn(help='', args=[d.arg(name='stream_parse', type=d.T.boolean)]),
        withStream_parse(stream_parse): { vm_scrape_params+: { stream_parse: stream_parse } },
      },
      ...
      withMetricRelabelConfigs(metricRelabelConfigs): { metricRelabelConfigs: if std.isArray(v=metricRelabelConfigs) then metricRelabelConfigs else [metricRelabelConfigs] },
      ...
      withMetricRelabelConfigsMixin(metricRelabelConfigs): { metricRelabelConfigs+: if std.isArray(v=metricRelabelConfigs) then metricRelabelConfigs else [metricRelabelConfigs] },
      ...
      withRelabelConfigs(relabelConfigs): { relabelConfigs: if std.isArray(v=relabelConfigs) then relabelConfigs else [relabelConfigs] },
      ...
      withRelabelConfigsMixin(relabelConfigs): { relabelConfigs+: if std.isArray(v=relabelConfigs) then relabelConfigs else [relabelConfigs] },
      '#withSampleLimit':: d.fn(help='"SampleLimit defines per-endpoint limit on number of scraped samples that will be accepted."', args=[d.arg(name='sampleLimit', type=d.T.integer)]),
      withSampleLimit(sampleLimit): { sampleLimit: sampleLimit },
      ...
      withScrape_interval(scrape_interval): { scrape_interval: scrape_interval },
      ...
      withSeriesLimit(seriesLimit): { seriesLimit: seriesLimit },
      '#withTargetPort':: d.fn(help='"Name or number of the pod port this endpoint refers to. Mutually exclusive with port."', args=[d.arg(name='targetPort', type=d.T.any)]),
    ...
    '#selector':: d.obj(help='"Selector to select Endpoints objects by corresponding Service labels."'),
    selector: {
    ...
    '#withDiscoveryRole':: d.fn(help='"DiscoveryRole - defines kubernetes_sd role for objects discovery.\\nby default, its endpoints.\\ncan be changed to service or endpointslices.\\nnote, that with service setting, you have to use port: \\"name\\"\\nand cannot use targetPort for endpoints."', args=[d.arg(name='discoveryRole', type=d.T.string)]),
    withDiscoveryRole(discoveryRole): { spec+: { discoveryRole: discoveryRole } },
    '#withEndpoints':: d.fn(help='"A list of endpoints allowed as part of this ServiceScrape."', args=[d.arg(name='endpoints', type=d.T.array)]),
    withEndpoints(endpoints): { spec+: { endpoints: if std.isArray(v=endpoints) then endpoints else [endpoints] } },
    '#withEndpointsMixin':: d.fn(help='"A list of endpoints allowed as part of this ServiceScrape."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpoints', type=d.T.array)]),
