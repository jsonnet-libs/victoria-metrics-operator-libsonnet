  ...
  spec: {
    ...
    receivers: {
      ...
      discord_configs: {
        ...
        http_config: {
          '#basic_auth':: d.obj(help='"TODO oAuth2 support\\nBasicAuth for the client."'),
          basic_auth: {
      ...
      wechat_configs: {
        ...
        '#withApi_url':: d.fn(help='"The WeChat API URL."', args=[d.arg(name='api_url', type=d.T.string)]),
        withApi_url(api_url): { api_url: api_url },
        '#withCorp_id':: d.fn(help='"The corp id for authentication."', args=[d.arg(name='corp_id', type=d.T.string)]),
    ...
    route: {
      ...
      '#withMute_time_intervals':: d.fn(help='"MuteTimeIntervals for alerts"', args=[d.arg(name='mute_time_intervals', type=d.T.array)]),
    ...
    '#time_intervals':: d.obj(help='"ParsingError contents error with context if operator was failed to parse json object from kubernetes api server\\nTimeIntervals modern config option, use it instead of  mute_time_intervals"'),
    time_intervals: {
      '#time_intervals':: d.obj(help='"TimeIntervals interval configuration"'),
      time_intervals: {
        '#times':: d.obj(help='"Times defines time range for mute"'),
    ...
    '#with':: d.fn(help='', args=[d.arg(name='_', type=d.T.string)]),
    with(_): { spec+: { '-': _ } },
    ...
    '#withMute_time_intervals':: d.fn(help='"MuteTimeInterval - global mute time\\nSee https://prometheus.io/docs/alerting/latest/configuration/#mute_time_interval"', args=[d.arg(name='mute_time_intervals', type=d.T.array)]),
    ...
    '#withMute_time_intervalsMixin':: d.fn(help='"MuteTimeInterval - global mute time\\nSee https://prometheus.io/docs/alerting/latest/configuration/#mute_time_interval"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='mute_time_intervals', type=d.T.array)]),
    ...
    '#withReceivers':: d.fn(help='"Receivers defines alert receivers.\\nwithout defined Route, receivers will be skipped."', args=[d.arg(name='receivers', type=d.T.array)]),
    ...
    '#withTime_intervals':: d.fn(help='"ParsingError contents error with context if operator was failed to parse json object from kubernetes api server\\nTimeIntervals modern config option, use it instead of  mute_time_intervals"', args=[d.arg(name='time_intervals', type=d.T.array)]),
    ...
    '#withTime_intervalsMixin':: d.fn(help='"ParsingError contents error with context if operator was failed to parse json object from kubernetes api server\\nTimeIntervals modern config option, use it instead of  mute_time_intervals"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='time_intervals', type=d.T.array)]),
