{
  ...
  '#':: d.pkg(name='vmProbe', url='', help='"VMProbe defines a probe for targets, that will be executed with prober,\\nlike blackbox exporter.\\nIt helps to monitor reachability of target with various checks."'),
  ...
  '#new':: d.fn(help='new returns an instance of VMProbe', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.victoriametrics.com/v1beta1',
    kind: 'VMProbe',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VMProbeSpec contains specification parameters for a Probe."'),
  spec: {
    ...
    targets: {
      ...
      ingress: {
        ...
        '#relabelingConfigs':: d.obj(help='"RelabelConfigs to apply to samples during service discovery."'),
        relabelingConfigs: {
        ...
        '#withRelabelingConfigs':: d.fn(help='"RelabelConfigs to apply to samples during service discovery."', args=[d.arg(name='relabelingConfigs', type=d.T.array)]),
      ...
      '#staticConfig':: d.obj(help='"StaticConfig defines static targets which are considers for probing."'),
      staticConfig: {
        '#relabelingConfigs':: d.obj(help='"RelabelConfigs to apply to samples during service discovery."'),
        relabelingConfigs: {
          '#withAction':: d.fn(help="\"Action to perform based on regex matching. Default is 'replace'\"", args=[d.arg(name='action', type=d.T.string)]),
        ...
        '#withTargets':: d.fn(help='"Targets is a list of URLs to probe using the configured prober."', args=[d.arg(name='targets', type=d.T.array)]),
        withTargets(targets): { spec+: { targets+: { staticConfig+: { targets: if std.isArray(v=targets) then targets else [targets] } } } },
        '#withTargetsMixin':: d.fn(help='"Targets is a list of URLs to probe using the configured prober."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targets', type=d.T.array)]),
        withTargetsMixin(targets): { spec+: { targets+: { staticConfig+: { targets+: if std.isArray(v=targets) then targets else [targets] } } } },
      },
    },
    ...
    vm_scrape_params: {
      ...
      withMetric_relabel_debug(metric_relabel_debug): { spec+: { vm_scrape_params+: { metric_relabel_debug: metric_relabel_debug } } },
      ...
      withRelabel_debug(relabel_debug): { spec+: { vm_scrape_params+: { relabel_debug: relabel_debug } } },
    ...
    '#withInterval':: d.fn(help='"Interval at which targets are probed using the configured prober.\\nIf not specified global scrape interval is used."', args=[d.arg(name='interval', type=d.T.string)]),
    ...
    '#withScrapeTimeout':: d.fn(help='"Timeout for scraping metrics from the blackbox exporter."', args=[d.arg(name='scrapeTimeout', type=d.T.string)]),
