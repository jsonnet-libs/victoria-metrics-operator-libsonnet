{
  ...
  spec: {
    ...
    '#extraEnvs':: d.obj(help='"ExtraEnvs that will be added to VMAlert pod"'),
    extraEnvs: {
    ...
    '#image':: d.obj(help='"Image - docker image settings for VMAlert\\nif no specified operator uses default config version"'),
    image: {
    ...
    '#withReplicaCount':: d.fn(help='"ReplicaCount is the expected size of the VMAlert cluster. The controller will\\neventually make the size of the running cluster equal to the expected\\nsize."', args=[d.arg(name='replicaCount', type=d.T.integer)]),
