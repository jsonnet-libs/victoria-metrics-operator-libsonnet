{
  ...
  '#':: d.pkg(name='vmPodScrape', url='', help="\"VMPodScrape is scrape configuration for pods,\\nit generates vmagent's config for scraping pod targets\\nbased on selectors.\""),
  ...
  '#new':: d.fn(help='new returns an instance of VMPodScrape', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.victoriametrics.com/v1beta1',
    kind: 'VMPodScrape',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VMPodScrapeSpec defines the desired state of VMPodScrape"'),
  spec: {
    ...
    podMetricsEndpoints: {
      ...
      '#withFilterRunning':: d.fn(help='"FilterRunning applies filter with pod status == running\\nit prevents from scrapping metrics at failed or succeed state pods.\\nenabled by default"', args=[d.arg(name='filterRunning', type=d.T.boolean)]),
      ...
      '#withSampleLimit':: d.fn(help='"SampleLimit defines per-podEndpoint limit on number of scraped samples that will be accepted."', args=[d.arg(name='sampleLimit', type=d.T.integer)]),
      ...
      '#withTargetPort':: d.fn(help='"TargetPort\\nName or number of the pod port this endpoint refers to. Mutually exclusive with port."', args=[d.arg(name='targetPort', type=d.T.any)]),
