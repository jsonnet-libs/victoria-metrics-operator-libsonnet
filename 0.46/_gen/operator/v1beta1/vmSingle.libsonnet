{
  ...
  spec: {
    ...
    '#extraEnvs':: d.obj(help='"ExtraEnvs that will be added to VMSingle pod"'),
    extraEnvs: {
    ...
    '#image':: d.obj(help='"Image - docker image settings for VMSingle\\nif no specified operator uses default config version"'),
    image: {
    ...
    '#withConfigMaps':: d.fn(help='"ConfigMaps is a list of ConfigMaps in the same namespace as the VMSingle\\nobject, which shall be mounted into the VMSingle Pods."', args=[d.arg(name='configMaps', type=d.T.array)]),
    withConfigMaps(configMaps): { spec+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } },
    '#withConfigMapsMixin':: d.fn(help='"ConfigMaps is a list of ConfigMaps in the same namespace as the VMSingle\\nobject, which shall be mounted into the VMSingle Pods."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configMaps', type=d.T.array)]),
    ...
    '#withExtraArgs':: d.fn(help='"ExtraArgs that will be passed to  VMSingle pod\\nfor example remoteWrite.tmpDataPath: /tmp"', args=[d.arg(name='extraArgs', type=d.T.object)]),
    withExtraArgs(extraArgs): { spec+: { extraArgs: extraArgs } },
    '#withExtraArgsMixin':: d.fn(help='"ExtraArgs that will be passed to  VMSingle pod\\nfor example remoteWrite.tmpDataPath: /tmp"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extraArgs', type=d.T.object)]),
    withExtraArgsMixin(extraArgs): { spec+: { extraArgs+: extraArgs } },
    '#withExtraEnvs':: d.fn(help='"ExtraEnvs that will be added to VMSingle pod"', args=[d.arg(name='extraEnvs', type=d.T.array)]),
    withExtraEnvs(extraEnvs): { spec+: { extraEnvs: if std.isArray(v=extraEnvs) then extraEnvs else [extraEnvs] } },
    '#withExtraEnvsMixin':: d.fn(help='"ExtraEnvs that will be added to VMSingle pod"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extraEnvs', type=d.T.array)]),
    ...
    '#withSecrets':: d.fn(help='"Secrets is a list of Secrets in the same namespace as the VMSingle\\nobject, which shall be mounted into the VMSingle Pods."', args=[d.arg(name='secrets', type=d.T.array)]),
    withSecrets(secrets): { spec+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } },
    '#withSecretsMixin':: d.fn(help='"Secrets is a list of Secrets in the same namespace as the VMSingle\\nobject, which shall be mounted into the VMSingle Pods."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
