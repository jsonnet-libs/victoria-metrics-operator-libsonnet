  ...
  spec: {
    ...
    aPIServerConfig: {
      ...
      basicAuth: {
        ...
        '#withPassword_file':: d.fn(help='"PasswordFile defines path to password file at disk"', args=[d.arg(name='password_file', type=d.T.string)]),
    ...
    '#withOverrideHonorLabels':: d.fn(help='"OverrideHonorLabels if set to true overrides all user configured honor_labels.\\nIf HonorLabels is set in ServiceScrape or PodScrape to true, this overrides honor_labels to false."', args=[d.arg(name='overrideHonorLabels', type=d.T.boolean)]),
