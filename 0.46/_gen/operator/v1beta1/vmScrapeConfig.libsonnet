{
  ...
  spec: {
    ...
    '#withHonorTimestamps':: d.fn(help='"HonorTimestamps controls whether to respect the timestamps present in scraped data."', args=[d.arg(name='honorTimestamps', type=d.T.boolean)]),
    ...
    '#withMetricsPath':: d.fn(help='"MetricsPath HTTP path to scrape for metrics. If empty, use the default value (e.g. /metrics)."', args=[d.arg(name='metricsPath', type=d.T.string)]),
