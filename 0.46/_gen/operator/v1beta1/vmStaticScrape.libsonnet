{
  ...
  '#':: d.pkg(name='vmStaticScrape', url='', help='"VMStaticScrape  defines static targets configuration for scraping."'),
  ...
  '#new':: d.fn(help='new returns an instance of VMStaticScrape', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'operator.victoriametrics.com/v1beta1',
    kind: 'VMStaticScrape',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VMStaticScrapeSpec defines the desired state of VMStaticScrape."'),
  spec: {
    '#targetEndpoints':: d.obj(help='"A list of target endpoints to scrape metrics from."'),
    targetEndpoints: {
      ...
      '#withLabels':: d.fn(help='"Labels static labels for targets."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { labels: labels },
      '#withLabelsMixin':: d.fn(help='"Labels static labels for targets."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { labels+: labels },
      ...
      '#withPort':: d.fn(help='"Default port for target."', args=[d.arg(name='port', type=d.T.string)]),
      ...
      '#withTargets':: d.fn(help='"Targets static targets addresses in form of [\\"192.122.55.55:9100\\",\\"some-name:9100\\"]."', args=[d.arg(name='targets', type=d.T.array)]),
      withTargets(targets): { targets: if std.isArray(v=targets) then targets else [targets] },
      '#withTargetsMixin':: d.fn(help='"Targets static targets addresses in form of [\\"192.122.55.55:9100\\",\\"some-name:9100\\"]."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targets', type=d.T.array)]),
      withTargetsMixin(targets): { targets+: if std.isArray(v=targets) then targets else [targets] },
    },
    '#withJobName':: d.fn(help='"JobName name of job."', args=[d.arg(name='jobName', type=d.T.string)]),
    ...
    '#withTargetEndpoints':: d.fn(help='"A list of target endpoints to scrape metrics from."', args=[d.arg(name='targetEndpoints', type=d.T.array)]),
    withTargetEndpoints(targetEndpoints): { spec+: { targetEndpoints: if std.isArray(v=targetEndpoints) then targetEndpoints else [targetEndpoints] } },
    '#withTargetEndpointsMixin':: d.fn(help='"A list of target endpoints to scrape metrics from."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targetEndpoints', type=d.T.array)]),
    withTargetEndpointsMixin(targetEndpoints): { spec+: { targetEndpoints+: if std.isArray(v=targetEndpoints) then targetEndpoints else [targetEndpoints] } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
